  ...
  return (
    <div className="p-10">
      {feedbackList?.length === 0 ? (
        <>
          <h2 className="font-bold text-x1 text-gray-500">
            No Interview Feedback Record Found
          </h2>
        </>
      ) : (
        <>
          <h2 className="text-2x1 font-bold text-green-500">Congratulation</h2>
          ...
          {feedbackList &&
            feedbackList.map((item: any, index) => (
